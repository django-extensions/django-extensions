...
DJANGO_EXTENSIONS_MONGODB_DATABASE_NAME = os.environ.get('DJANGO_EXTENSIONS_MONGODB_DATABASE_NAME')
if DJANGO_EXTENSIONS_MONGODB_DATABASE_NAME:
    import mongoengine
    MONGO_DATABASE_HOST = f'mongodb://localhost:27017/{DJANGO_EXTENSIONS_MONGODB_DATABASE_NAME}'
    mongoengine.connect(DJANGO_EXTENSIONS_MONGODB_DATABASE_NAME, host=MONGO_DATABASE_HOST)
