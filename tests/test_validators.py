...
class NoControlCharactersValidatorTests(TestCase):
    ...
    def test_should_raise_default_message_and_code_if_value_contains_new_line(self):  # noqa
    ...
    def test_should_not_raise_if_value_contains_characters_which_is_on_whitelist(self):  # noqa
        self.validator = NoControlCharactersValidator(
...
class NoWhiteSpaceValidatorTests(TestCase):
    ...
    def test_should_raise_default_message_and_code_if_value_has_leading_whitespace(self):  # noqa
    ...
    def test_should_raise_custom_message_and_code_if_value_has_trailing_whitespace(self):  # noqa
        self.validator = NoWhitespaceValidator(
            message='custom message', code='custom code')
    ...
    def test_should_not_raise_if_value_doesnt_have_leading_or_trailing_whitespaces(self):  # noqa
        self.validator = NoWhitespaceValidator()
