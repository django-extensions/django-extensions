...
class SetDefaultSiteTests(TestCase):
    ...
    def test_should_raise_CommandError_when_Site_object_does_not_exist(self):  # noqa
    ...
    def test_should_raise_CommandError_if_system_fqdn_return_None(self, m_socket):  # noqa
    ...
    def test_should_raise_CommandError_if_both_domain_and_set_as_system_fqdn_are_present(self):  # noqa
    ...
    def test_should_raise_CommandError_Sites_framework_not_installed(self):  # noqa
        with self.assertRaisesRegex(
                CommandError,
    ...
    def test_should_print_Nothing_to_update(self, m_stdout):  # noqa
        call_command('set_default_site')
    ...
    @patch('django_extensions.management.commands.set_default_site.socket')
    def test_should_use_domain_as_name_if_system_fqdn_return_domain_and_name_is_not_provided(self, m_socket):  # noqa
    ...
    @patch('django_extensions.management.commands.set_default_site.socket')
    def test_should_set_custom_nameif_system_fqdn_return_domain_and_name_is_provided(self, m_socket):  # noqa
        m_socket.getfqdn.return_value = 'test.com'
    ...
    def test_should_set_name_and_domain_if_provided(self):  # noqa
    ...
    def test_should_set_name_only(self):  # noqa
    ...
    def test_should_set_domain_only(self):  # noqa
