...
class UpdatePermissionsTests(TestCase):
    ...
    def test_should_reload_permission_only_for_specified_apps(self):
        ...
        sys.stdout = original_stdout
        self.assertNotIn(f'{DJANGO_EXTENSIONS_NAME} | perm model | Can add perm model', out.getvalue())
        self.assertIn(f'{TESTAPP_NAME} | test model | Can add test model', out.getvalue())
    ...
    def test_should_reload_permission_only_for_all_apps(self):
        ...
        sys.stdout = original_stdout
        self.assertIn(f'{DJANGO_EXTENSIONS_NAME} | perm model | Can add perm model', out.getvalue())
        self.assertIn(f'{TESTAPP_NAME} | test model | Can add test model', out.getvalue())
    ...
    def test_should_update_permission_if_name_changed(self):
        ...
        self.assertIn(f'{TESTAPP_NAME} | test model | testapp_permission', out.getvalue())
        ...
        sys.stdout = original_stdout
        self.assertIn(f"'{TESTAPP_NAME} | test model | testapp_permission_wrong' to '{TESTAPP_NAME} | test model | testapp_permission'", out.getvalue())
