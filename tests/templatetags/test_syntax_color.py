...
class SyntaxColorTagTests(TestCase):
    ...
    def test_should_generate_pygments_css_file_in_temp_directory(self):  # noqa
        generate_pygments_css(self.tmpdir)

        self.assertTrue(os.path.exists(
            os.path.join(self.tmpdir, 'pygments.css')))

    def test_pygments_css_should_return_highlight_css(self):  # noqa
...
"""
    ...
    def test_should_colorize_with_default_lexer(self):  # noqa
...
"""
    ...
    def test_colorize_should_return_value_if_lexer_class_not_found(self):  # noqa
        ctx = Context({'code_string': '<h1>TEST</h1>'})
        content = """{% load syntax_color %}
...
"""
    ...
    def test_should_colorize_table_with_default_lexer(self):  # noqa
        ctx = Context({'code_string': '<h1>TEST</h1>'})
        content = """{% load syntax_color %}
...
"""
    ...
    def test_colorize_table_should_return_value_if_lexer_class_not_found(self):  # noqa
        ctx = Context({'code_string': '<h1>TEST</h1>'})
        content = """{% load syntax_color %}
...
"""
    ...
    def test_should_colorize_noclasses_with_default_lexer(self):  # noqa
        ctx = Context({'code_string': '<h1>TEST</h1>'})
        content = """{% load syntax_color %}
...
"""
    ...
    def test_colorize_noclasses_should_return_value_if_lexer_class_not_found(self):  # noqa
        ctx = Context({'code_string': '<h1>TEST</h1>'})
        content = """{% load syntax_color %}
